...
public class ThemeOverlayControllerGoogle extends ThemeOverlayController {
    ...
    private final ConfigurationListener darkConfigurationListener =
            new ConfigurationListener() {
                ...
                public void onUiModeChanged() {
                    Log.d(TAG, "Restart SystemUI on UI change");
                    restartSystemUI();
                }
            };
    ...
    public ThemeOverlayControllerGoogle(Context context, BroadcastDispatcher broadcastDispatcher,
        ...
        super(context, broadcastDispatcher, bgHandler, mainExecutor, bgExecutor,
                ...
                configurationController, deviceProvisionedController, userTracker,
                dumpManager, featureFlags, resources, wakefulnessLifecycle, systemSettings);
